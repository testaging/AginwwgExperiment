...
class cheeseTest(object):
    def __call__(self):
        temp = os.popen('adb shell dumpsys meminfo com.support.android.designlibdemo').readlines()
        timestamp = time.ctime()
        return ('cheesesquare', timestamp, temp)
...
if __name__ == '__main__':
    ...
    f1 = open('getData//cheesesquare', 'w')
