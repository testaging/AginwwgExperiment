...
class ZhihuTest(object):
    def __call__(self):
        temp = os.popen('adb shell dumpsys meminfo io.github.izzyleung.zhihudailypurify').readlines()
